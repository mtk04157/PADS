...
Sub ParsePadData(ByVal ascFile As String, ByVal compCount As Integer)
	Dim fh As Integer
	Dim line As String
	Dim i As Integer
...
Sub CalculateCompactLayout(ByVal PCBDoc, ByVal compCount As Integer, ByVal padding As Double)
